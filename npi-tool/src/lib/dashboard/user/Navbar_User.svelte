...
<Sidebar>
  <SidebarWrapper>
    <SidebarGroup>
      <SidebarItem label="Dashboard" href='{baseUrl}/{email}'>
      ...
      <SidebarItem label="My Orders" {spanClass} href='{baseUrl}/{email}/orders'>
        <svelte:fragment slot="icon">
      ...
      <SidebarItem label="User Settings" {spanClass} href='{baseUrl}/{email}/settings'>
        <svelte:fragment slot="icon">
